package Tutor;
/** this program test the GUI components
 * 
 * @author Robby1
 *
 */
...
public class GUIComponents {
	public static void main(String[] args){
		...
		// Create a panel to group compoents
		...
		panel.add(jrbRed); //Add the radio box to the the panel
		panel.add(jrbYellow); //Add the radio box to the panel
